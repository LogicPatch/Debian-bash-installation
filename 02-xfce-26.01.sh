...
echo ""
echo -e ${ifyellow} '>>>>> Hier wird eine komplettinstallation von Xfce angeboten, für den Fall dass noch\n      keine Installation von Xfce durchgeführt wurde oder die Installation von Xfce\n      fehlerhaft ist und die Konfiguration zurückgesetzt werden soll.'${KF}




echo ""
read -p "Soll eine Komplettinstallation von Xfce durchgeführt werden? (Y/n): " xfce
read -p "Sollen noch weitere Anwendungen speziell für den Xfce-Desktop installiert werden? (Y/n): " appsxfce
