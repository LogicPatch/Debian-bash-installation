...
themes () {
    echo ""
    echo -e ${ifgrn} '>>>>> Weitere GTK-Themes werden installiert.'${KF}
    sleep 3
...
themesqt () {
    echo ""
    echo -e ${ifgrn} '>>>>> Weitere Qt-Themes werden installiert.'${KF}
    sleep 3
...
icons () {
    echo ""
    echo -e ${ifgrn} '>>>>> Weitere Icon-Themes werden installiert.'${KF}
    sleep 3
...
fonts () {
    echo ""
    echo -e ${ifgrn} '>>>>> Weitere Schriftarten werden installiert.'${KF}
    sleep 3
...
displaymanager () {
    case $displaymanager in
        1*)
            ##### LightDM 
            echo ""
            echo -e ${ifgrn}'>>>>> LightDM - Der Standarddisplaymanager von xfce, budgie, i3 u.a. wird installiert.'${KF}
            sleep 3
            sudo apt install -y lightdm lightdm-settings lightdm-gtk-greeter lightdm-gtk-greeter-settings slick-greeter
            #echo ""
            #echo -e ${ifyellow}'Bitte wählen Sie den zu verwendenden Displaymanager aus der Liste aus.'${KF}
            #sudo dpkg-reconfigure lightdm
    ;;
        2*)
            ##### GDM
            echo ""
            echo -e ${ifgrn}'>>>>> GDM - Der Standard-Displaymanager von Gnome wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### SDDM
            echo ""
            echo -e ${ifgrn}'>>>>> sddm - Der Simple-Desktop-Display-Manager von KDE-Plasma wird installiert.'${KF}
            sleep 3
...
files () {
    case $files in
        1*)
            ##### thunar 
            echo ""
            echo -e ${ifgrn}'>>>>> thunar - Der Dateibrowser des Xfce4-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### nautlius
            echo ""
            echo -e ${ifgrn}'>>>>> nautlius - Der Dateibrowser des Gnome-Desktop wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### dolphin
            echo ""
            echo -e ${ifgrn}'>>>>> dolphin - Der Dateibrowser des KDE-Plasma-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ##### Alle Dateibrowser
            echo ""
            echo -e ${ifgrn}'>>>>> Es werden zunächst alle Dateibrowser für eine spätere Selektion installiert.'${KF}
            sleep 3
...
kalender () {
    case $kalender in
        1*)
            ##### gnome-calendar 
            echo ""
            echo -e ${ifgrn}'>>>>> gnome-calendar des Gnome-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### korganizer
            echo ""
            echo -e ${ifgrn}'>>>>> korganizer von KDE-Plasma wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### calindori
            echo ""
            echo -e ${ifgrn}'>>>>> calindori für Plasma-Mobile wird installiert.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ...
            echo ""
            echo -e ${ifgrn}'>>>>> Es werden zunächst alle Kalenderapplikationen für eine spätere Selektion installiert.'${KF}
            sleep 3
...
editor () {
    case $editor in
        1*)
            ##### gedit
            echo ""
            echo -e ${ifgrn}'>>>>> gedit des Gnome-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### kate
            echo ""
            echo -e ${ifgrn}'>>>>> kate von KDE-Plasma wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### geany
            echo ""
            echo -e ${ifgrn}'>>>>> geany - Kann über Plugins erweitert werden.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ...
            echo ""
            echo -e ${ifgrn}'>>>>> Es werden zunächst alle Editorapplikationen für eine spätere Selektion installiert.'${KF}
            sleep 3
...
image () {
    case $image in
        1*)
            ##### eog
            echo ""
            echo -e ${ifgrn}'>>>>> eog - Der Bildbetrachter des Gnome-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### gwenview
            echo ""
            echo -e ${ifgrn}'>>>>> gwenview - Der Bildbetrachter des KDE-Plasma-Desktop wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### lximage
            echo ""
            echo -e ${ifgrn}'>>>>> lximage - Der Bildbetrachter des LxQT-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ##### sxiv
            echo ""
            echo -e ${ifgrn}'>>>>> sxiv - Ein schlanker und schneller Bildbetrachter mit vielen Funktionen wird installiert.'${KF}
            sleep 3
...
pdf () {
    case $pdf in
        1*)
            ##### papers
            echo ""
            echo -e ${ifgrn}'>>>>> papers - Der PDF-Reader des Gnome-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### okular
            echo ""
            echo -e ${ifgrn}'>>>>> okular - Der PDF-Reader des KDE-Plasma-Desktop wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### mupdf
            echo ""
            echo -e ${ifgrn}'>>>>> mupdf - Ein schlanker und schneller PDF-Reader Bildbetrachter mit vielen Funktionen wird installiert.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ##### Alle PDF-Reader
            echo ""
            echo -e ${ifgrn}'>>>>> Es werden zunächst alle PDF-Reader für eine spätere Selektion installiert.'${KF}
            sleep 3
...
screen () {
    case $screen in
        1*)
            ##### flameshot
            echo ""
            echo -e ${ifgrn}'>>>>> flameshot wird installiert.'${KF}
            sleep 3
    ...
    ;;
        2*)
            ##### spectacle
            echo ""
            echo -e ${ifgrn}'>>>>> spectacle - Das Screenshot-Tool des KDE-Plasma-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;
        3*)
            ##### scrot
            echo ""
            echo -e ${ifgrn}'>>>>> scrot für die Kommandozeile wird installiert.'${KF}
            sleep 3
    ...
    ;;
        4*)
            ##### xfce4-screenshooter
            echo ""
            echo -e ${ifgrn}'>>>>> xfce4-screenshooter - Das Screenshot-Tool des xfce-Desktops wird installiert.'${KF}
            sleep 3
    ...
    ;;    
        5*)
            ...
            echo ""
            echo -e ${ifgrn}'>>>>> Für eine spätere Selektion werden zunächst alle Tools für Screenshots installiert.'${KF}
            sleep 3
